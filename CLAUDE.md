...
> This file is loaded for every project. Keep it lean — project-specific context goes in project-level CLAUDE.md files.
...
- **BEFORE compacting, ALWAYS write current state to a summary file first** — compaction loses detail you cannot recover

### Rule 3: One Concern Per Session

- **Session = one phase of work** (research OR implementation OR review — not all three)
...
|----|------|---|-------|------|
| #111 | 3:21 PM | 🔵 | MCP Server Status Check Reveals Five Failed Connections After Configuration Fix | ~411 |
| #100 | 3:17 PM | 🔵 | MCP Configuration Errors Persist for Atlassian and SkillsMP Servers | ~325 |
| #75 | 2:21 PM | 🔵 | Claude Desktop Main Configuration Has Empty MCP Servers Section | ~290 |
| #53 | 10:52 AM | 🔴 | Fixed UV Command Path in Claude Desktop MCP Configuration | ~276 |
| #52 | 10:51 AM | 🔵 | Claude Configuration Includes Direct MCP Code-Search Server Definition | ~387 |
| #47 | 10:46 AM | 🔵 | Claude Configuration Tracks Extensive Project Usage and Token Consumption Metrics | ~496 |
| #33 | 9:32 AM | 🔵 | Claude Configuration Directory Shows Active Session with History and Debug Logging | ~338 |
</claude-mem-context>
